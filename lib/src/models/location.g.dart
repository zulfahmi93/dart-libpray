...
class _$GeocoordinateSerializer implements StructuredSerializer<Geocoordinate> {
  ...
  @override
  Iterable serialize(Serializers serializers, Geocoordinate object,
  ...
  @override
  Geocoordinate deserialize(Serializers serializers, Iterable serialized,
      {FullType specifiedType = FullType.unspecified}) {
...
class _$Geocoordinate extends Geocoordinate {
  ...
  factory _$Geocoordinate([void updates(GeocoordinateBuilder b)]) =>
  ...
  @override
  Geocoordinate rebuild(void updates(GeocoordinateBuilder b)) =>
...
class GeocoordinateBuilder
  ...
  @override
  void update(void updates(GeocoordinateBuilder b)) {
